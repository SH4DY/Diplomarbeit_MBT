...
Es folgt der Code zum Beispiel aus dem Kapitel \ref{sec:results} - \nameref{sec:results}. Hier wird das \Gls{SUT} im GraphML Format dargestellt. Graphwalker erzeugt ein Java Interface, welches der Testentwickler mit Adapter-Code befüllt. In diesem Beispiel wurde Selenium verwendet um die Applikation anzusteuern.\\
...
Vollständiges Beispiel, inklusive der generierten GraphML Dateien, zu finden unter: \url{https://github.com/SH4DY/ImexTest/} \todo[color=blue]{sollte nur einmal am Anfang stehen!}
...
Das vollständige Beispiel ist zu finden unter: \url{https://github.com/SH4DY/FluentCoS/}\todo[color0blue]{würde das zu Beginn des Anhang schreiben}
...
\begin{lstlisting}[caption=Demand111958.java, label=code:fluent_demand]
