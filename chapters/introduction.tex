...
\todo[inline]{Der folgende Absatz ist zu detaliert für die Motivation...}
In der Zwischenzeit sind Ansätze nötig, die die Erkenntnisse des automatisierten Softwaretests übernehmen und neuartige Methoden zur Qualitätserhöhung und Wartungsreduzierung einbringen. Einer dieser Ansätze ist das\todo{erstes Vorkommen, eventuell in der Kurzfassung ausschreiben dort keine Abkürzungen verwednen. Allerdings staret der nächste Satz wieder mit modellbasiertes Testen, eventuell umformulieren.} \Gls{MBT}. Das modellbasierte Testen zieht eine Schicht zwischen den logischen und technischen Teil eines Tests. Es findet also eine Abstrahierung auf Modelle des tatsächlichen Systems statt. Dies ermöglicht die wartungsintensiven Implementierungsdetails von den Abläufen des Tests zu entkoppeln, zu modularisieren und bestenfalls wieder zu gebrauchen.\\
...
\todo[inline]{Ich würde im Aufbau nicht auf X.X.X verweisen, es genügt auf X oder max. auf X.X zu verweisen, der Rest ist im Inhatskapitel ersichtlich.}