...
\begin{itemize}
	...
	\item Qualitätssicherung als auch Entwicklung würden erheblich entlastet. Damit würden Ressourcen verfügbar gemacht werden, die für neue oder verbesserte Funktionalitäten eingesetzt werden könnten.
\end{itemize}
...
\begin{itemize}
	...
	\item Kann ein Modellformat und eine passendes Werkzeug gefunden bzw. entwickelt werden, um Testfällle generieren generieren zu lassen, die denselben Nutzen wie manuelle Systemtests haben?
