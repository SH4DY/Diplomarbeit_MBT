...
Für diese Fallstudie wurden Interviews mit dem leitenden Architekten der Applikation, einem Entwickler, einer Business-Analystin und einem Testverantwortlichen geführt.\todo{Müssen wir mit Mario abklären, kann sein das die Interviews in die Arbeit aufgenommen werden müssen, oder wir formulieren das um.} Die hier dargestellten Punkte stellen eine Zusammenfassung aller gesammelten Meinungen dar.\\
\begin{itemize}
...
Die oben erwähten Schwächen, die Einfluss auf die Qualitätssicherung haben, könnten folgendermaßen verbessert \todo{Feedback einarbeiten, können auf Grund der Erfahrung des Autors, oder Vorschläge der interviewten Personen, ... oder nach Literatur ... }werden:
