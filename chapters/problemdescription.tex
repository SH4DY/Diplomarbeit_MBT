...
\begin{itemize}
\item \texttt{Object getState()} Diese Methode gibt den momentanten Zustand des SUT, so wie er im Modell repräsentiert wird, zurück. Im einfachsten Fall ist dies eine Abstraktion als String, es können aber beliebige Objekte zurückgegeben werden.
