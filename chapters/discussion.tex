...
Die Auswahl des Modellformats ist eine fundamentale Entscheidung. Kein Modellformat hat sich wirklich durchgsetzt, Werkzeuge verwenden oft proprietäre oder nicht-standardisierte Formate. Die Gefahr in einer Sackgasse zu landen ist groß. Wie schon Simon Mills\cite{graham_experiences_2012} bezüglich Skriptsprachen im Kontext von automatisierten GUI-Tests berichtet, ist es sehr vorteilhaft sich in keine Abhängigkeit mit einem Tool-Hersteller zu bringen, obwohl das Tool zur Zeit verwendet wird.
\fi\makeatother