...
\begin{lstlisting}[language=Java, caption={Beispielhaftes Codestück eines \Gls{BDD} Tests},label=lst:bddcode]
...
\begin{fullpage}
\hspace*{-2cm}
\includegraphics[width=1.0\textwidth]{figures/modell_logisch_right.png}
