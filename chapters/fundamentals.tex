...
\todo{Abbildung zu V-Modell siehe Basiswissen SWT Seite 38} Abbildung XY zeigt ein klassisches V-Modell und dessen Komponenten. Es ist sofort erkenntlich, dass die Aktivitäten auf der linken Seite eng an das Wasserfallmodell \todo{erste Erwähnung Wasserfall? Dann Referenz} angelehnt sind.
\begin{itemize}
