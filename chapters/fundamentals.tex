...
\begin{lstlisting}[caption=Vorlage für Behaviour Driven Tests in Prosatext, label=lst:bdt_template]
...
\begin{lstlisting}[caption=Beispielhafter Behaviour Driven Test, label=lst:bdt_test]
