...
Eine Aktivität die es im skriptbasierten Test nicht gibt ist die Wahl der Traversierungskriterien bzw. Abdeckungskriterien. 

\begin{figure}[h] 
  \centering
     \includegraphics[width=1\textwidth]{figures/mbt_vergleich_skript.png}
