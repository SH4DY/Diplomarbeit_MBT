...
\subsubsection{Werkzeug Landschaft}
Wie auf dem Feld der skriptbasierten Testautomatisierung, ist die Auswahl an Werkzeugen zur Unterstützung von modellbasierten Tests vielfältig. Modellbasiertes Testen umfasst in der Regel mehrere Aktivitäten, für die jede Kombination aus passenden kommerziell erhältlichen Werkzeugen herangezogen werden können. Auch die marktführenden Hersteller haben begonnen ihre Testing Applikations-Suiten für MBT auszurüsten. 
